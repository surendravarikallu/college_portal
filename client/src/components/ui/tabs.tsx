...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl glass-card p-1 text-muted-foreground shadow-lg",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "hover:bg-white/50 hover:text-foreground hover:scale-105 hover:shadow-md",
      "data-[state=active]:bg-white data-[state=active]:text-foreground data-[state=active]:shadow-lg data-[state=active]:scale-105",
      "magnetic ripple",
      className
    )}
    {...props}
